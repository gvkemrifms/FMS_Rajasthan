...
{
    public partial class VehicleMaintenanceEdit : System.Web.UI.Page
    {
        ...
        public void GetVehicleNumber()
        {
            ...
            ddlVehicleNumber.DataSource = fmsVas.GetOffRoadVehiclesall();// .GetVehicleNumber();
            //ddlVehicleNumber.DataValueField = "ORV_VehicleNumber";
        ...
        {
            ddlDistrict.DataSource = fmsobj.GetDistrict();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //fmsVas.MaintenanceDate = DateTime.Parse(txtMaintenanceDate.Text);
            //fmsVas.DownTimeOdoReading = txtDownOdo.Text;
            //fmsVas.Downtime = DateTime.Parse(txtDownTime.Text);
            //fmsVas.UptimeOdoReading = txtUpOdo.Text;
            //fmsVas.Uptime = DateTime.Parse(txtUptime.Text + " " + ddlUpHour.SelectedValue + ":" + ddlUpMin.SelectedValue + ":00");
            ...
            int insres = fmsVas.UpdateOffRoadVehcileMaintenanceall();
        ...
        protected void gvVehicleMaintenanceDetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "VehMainEdit")
            {
                ...
                if (chkbxlistBillType.Items[2].Selected)
                {
                    ...
                    {
                        VehicleNo = Convert.ToString(ddlVehicleNumber.SelectedValue);
                        int OffRoadId = Convert.ToInt32(ViewState["OffRoadId"]);

                        DataSet ds = vehMain.getcatedetailsEdit(OffRoadId);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
        ...
        {
            DataSet dsMaintainances = (DataSet)ViewState["Maintainances"];
            if (dsMaintainances.Tables[0].Rows.Count == 0)
            {
                SetInitialRowSP();
            }
            else
                    ...
                    if (dslabourFromDB.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < grdvwLabourBillDetails.Rows.Count; i++)
                        {
                            if (i < dt.Rows.Count)
                            {
                                ...
                                DataView dvagg = dslabourAggregatesnew.Tables[0].DefaultView;
        ...
        private void AddNewRowToGridLabour()
        {
            if (ViewState["LabourCurrentTable"] != null)
            {
                ...
                {
                    if (dtCurrentTableLabour.Rows[0][4].ToString() == "")
                    {
                        DataTable dt = (DataTable)ViewState["TempLabData"];
                        DropDownList ddl1 = (DropDownList)grdvwLabourBillDetails.Rows[0].Cells[1].FindControl("ddlLabourVendorName");
                        TextBox txt2 = (TextBox)grdvwLabourBillDetails.Rows[0].Cells[2].FindControl("txtLabourBillNo");
                        TextBox txt3 = (TextBox)grdvwLabourBillDetails.Rows[0].Cells[3].FindControl("txtLabourBillDate");
                        ComboBox ddl4 = grdvwLabourBillDetails.Rows[0].FindControl("ddlLabourAggregates") as ComboBox;
                        ComboBox ddl5 = grdvwLabourBillDetails.Rows[0].FindControl("ddlLabourCategories") as ComboBox;
                        ComboBox ddl6 = grdvwLabourBillDetails.Rows[0].FindControl("ddlLabourSubCategories") as ComboBox;
                        TextBox txt7 = (TextBox)grdvwLabourBillDetails.Rows[0].Cells[7].FindControl("txtLabourItemDesc");
                        TextBox txt8 = (TextBox)grdvwLabourBillDetails.Rows[0].Cells[8].FindControl("txtLabourQuant");
                        TextBox txt9 = (TextBox)grdvwLabourBillDetails.Rows[0].Cells[9].FindControl("txtLabourBillAmount");
                        dt.Rows[0][1] = ddl1.SelectedItem.Text;
                        dt.Rows[0][2] = txt2.Text;
                        dt.Rows[0][3] = txt3.Text;
                        dt.Rows[0][4] = ddl4.SelectedItem.Text;
                        dt.Rows[0][5] = ddl5.SelectedItem.Text;
                        dt.Rows[0][6] = ddl6.SelectedItem.Text;
                    ...
                    #region commented by swathi on 14th June 2016
                    //bool flag = false;
                    ...
                    for (int i = 0; i < dtCurrentTableLabour.Rows.Count - 1; i++)
                    {
                        ...
                        else if (ds.Tables[0].Rows.Count > i && ds.Tables[0].Rows[i][5].ToString() == "")
                        {
                            ddl5.SelectedItem.Text = ((ComboBox)grdvwLabourBillDetails.Rows[i].Cells[5].FindControl("ddlLabourCategories")).SelectedItem.Text;
                        }
                        else if (ds.Tables[0].Rows.Count > i)
                        ...
                        ComboBox ddlLabourAggregates = (ComboBox)grdvwLabourBillDetails.Rows[i].Cells[4].FindControl("ddlLabourAggregates");
                        ...
                        ComboBox ddlLabourCategories = (ComboBox)grdvwLabourBillDetails.Rows[i].Cells[5].FindControl("ddlLabourCategories");
                        ...
                        ComboBox ddlLabourSubCategories = (ComboBox)grdvwLabourBillDetails.Rows[i].Cells[6].FindControl("ddlLabourSubCategories");
            ...
            if (ViewState["LabourCurrentTable"] != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        if (ds == null)
                        {
                            // ------------------------By swathi on 14th June 2016
                            ddl4.Items.Clear();
                            ddl4.DataSource = dslabourAggregatesnew.Tables[0];
                            ((System.Data.DataTable)(ddl4.DataSource)).DefaultView.RowFilter = "";
                            ddl4.DataValueField = "Aggregate_Id";
                            ddl4.DataTextField = "Aggregates";
                            ddl4.DataBind();
                            ddl4.SelectedIndex = 0;
                        ...
                        TextBox txt8 = (TextBox)grdvwLabourBillDetails.Rows[i].Cells[8].FindControl("txtLabourQuant");
                        TextBox txt9 = (TextBox)grdvwLabourBillDetails.Rows[i].Cells[9].FindControl("txtLabourBillAmount");
                        txt9.Text = "";// By swathi on 14th June 2016
                        txt2.Text = "";// By swathi on 14th June 2016
                        txt3.Text = "";// By swathi on 14th June 2016
                        if (ds == null)
                        {
                            txt9.Text = "";// By swathi on 14th June 2016
                            //txt9.Text = dt.Rows[0][9].ToString(); // By swathi on 14th June 2016
                        }
                        ...
                        {
                            txt9.Text = "";// By swathi on 14th June 2016
                            //txt9.Text = ds.Tables[0].Rows[0][9].ToString(); // By swathi on 14th June 2016
                        }
                        ...
                        if (i < dt.Rows.Count - 1)
                        {
                            ...
                            DataView dvAggregateName = dt1.DefaultView; //new DataView(dt1);
                            ...
                            if (dt.Rows[i][4].ToString() != "")
                            {
                                ...
                                // ------------------------Commented By swathi on 14th June 2016    
                                //ddl4.Items.Clear();
                                //ddl4.DataSource = dslabourAggregatesnew.Tables[0];
                                //ddl4.DataValueField = "Aggregate_Id";
                                //ddl4.DataTextField = "Aggregates";
                            ...
                            if (dt.Rows[i][6].ToString() != "")
                            {
				// Show(dt.Rows[i][6].ToString());
                              //  string SubCategoryId = dvSubCategoryName.ToTable().Rows[i][6].ToString();
        ...
        private bool ValidateLabourGrid()
        {
            if (pnlLabourBillDetails.Visible == true)
            {
                for (int i = 0; i < grdvwLabourBillDetails.Rows.Count; i++)
                {
                    ...
                    else if (Convert.ToDateTime(Convert.ToDateTime(txtbxlabourdate.Text).ToString("dd/MM/yyyy")) > DateTime.Now)
                    {
			Show(Convert.ToDateTime(Convert.ToDateTime(txtbxlabourdate.Text).ToString("dd/MM/yyyy")).ToString());
        ...
        protected void grdvwSPBillDetails_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (isedit)
                {
                    ...
                    {
                        selectedID = Convert.ToString(dv.ToTable().Rows[0]["AgencyId"]);
                    }
                    ...
                    {
                        SparePartID = Convert.ToString(dv1.ToTable().Rows[0]["ManufacturerSpare_Id"]);
                    }
