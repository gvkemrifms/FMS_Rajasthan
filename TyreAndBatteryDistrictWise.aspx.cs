...
public partial class TyreAndBatteryDistrictWise : System.Web.UI.Page
{
    ...
    public void withoutdist()
    {
        try
        {
            ...
            cmd.CommandText = "P_Report_TyreReportAndBatteryDistrictWise";
            conn.Close();
            ...
            if (dt.Rows.Count > 0)
            {
                GrdtyreBattery.DataSource = dt;
                GrdtyreBattery.DataBind();
            }
            else
            {
                GrdtyreBattery.DataSource = null;
                GrdtyreBattery.DataBind();
            }
