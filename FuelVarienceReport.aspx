...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td>
       <asp:Label ID="lblvariencereport" style="font-size:20px;color:brown" runat="server" Text="FuelVarience&nbsp;Report"></asp:Label> 
        </td>
    </tr>
    </table>
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblbunk" runat="server" Text="Select&nbsp;Bunk"></asp:Label>              
        </td>
        
        <td>
            <asp:DropDownList ID="ddlbunk" runat="server" style="width:100px"></asp:DropDownList>
        </td>
