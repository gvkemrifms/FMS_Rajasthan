<%@ Page Title="" Language="C#" MasterPageFile="~/temp.master" AutoEventWireup="true" CodeFile="DetailedOffRoadDataReport.aspx.cs" Inherits="DetailedOffRoadDataReport" %>
...
<asp:BoundField DataField="ExpDateOfRecovery" HeaderText="Expected Date Of Recovery" />
 ...
 <asp:BoundField DataField="VendorPhoneNum" HeaderText="Vendor Phone" />
<asp:BoundField DataField="onroadPailot" HeaderText="On Road Pailot Name" />
<asp:BoundField DataField="onroadpailtid" HeaderText="On Road Pailot Id" />
