...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td>
       <asp:Label ID="lblcardtypereport" style="font-size:20px;color:brown" runat="server" Text="SparePartsWise&nbsp;Report"></asp:Label> 
        </td>
    </tr>
    </table>
   ...
   <td>
       <asp:Label ID="lblvendor" runat="server" Text="Spare&nbsp;VendorName"></asp:Label> 
   </td>
        <td>
