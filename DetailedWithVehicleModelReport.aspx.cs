...
public partial class DetailedWithVehicleModelReport : System.Web.UI.Page
{
    ...
    public void withoutdist()
    {
        try
        {
            ...
            cmd.CommandText = "P_FMSReports_SummaryDetailedWithVehicleModel";
            conn.Close();
            ...
            if (dt.Rows.Count > 0)
            {
                Grdvehmodel.DataSource = dt;
                Grdvehmodel.DataBind();
            }
            else
            {
                Grdvehmodel.DataSource = null;
                Grdvehmodel.DataBind();
            }
