<%@ Page Title="" Language="C#" MasterPageFile="~/temp.master" AutoEventWireup="true"
     CodeFile="VehicleMaintenanceDetailsNew.aspx.cs"
     Inherits="GvkFMSAPP.PL.VehicleMaintenanceandRepairs.VehicleMaintenanceDetailsNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <script language="javascript" type="text/javascript">
        ...
        function validation() {
            ...
            if (Date.parse(MaintenanceDate.value) > Date.parse(now.getDate() + "/" + now.getMonth()+1 + "/" + now.getFullYear() + " " + now.getHours() + ":" + now.getMinutes())) {
                ...
                <tr>
                    <td>
                        <fieldset style="padding: 10px">
                            ...
                            </table> <%--EnableSortingAndPagingCallbacks="True"--%>
                            <asp:GridView ID="gvVehicleMaintenanceDetails" runat="server" AllowPaging="True"
                                ...
                                CssClass="gridviewStyle" EmptyDataText="No Records Found" 
